...
if strcmp(direction, 'clockwise')
    ...
    r(1) = text(0.5, -0.05, B, 'horizontalalignment', 'center','Color','blue','FontSize',12);
    r(2) = text(1-0.4*sin(deg2rad(30)), 0.5, C,'rotation', -60,'horizontalalignment', 'center','Color','red','FontSize',12);
    r(3) = text(0.4*sin(deg2rad(30)), 0.5, A, 'rotation', 60,'horizontalalignment', 'center','Color','green','FontSize',12);
end
